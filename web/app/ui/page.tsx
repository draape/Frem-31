import { SoccerBallIcon, LightningIcon, TrophyIcon } from '@phosphor-icons/react/dist/ssr';
    ...
    <main>
      ...
      <section>
        ...
        <Hero
          ...
          description="Vi er en idrettsklubb på nedre Stabekk. Hos oss kan du spille fotball, gå på is med bandy eller bygge roboter med Lego League."
      ...
      <section style={{ borderTop: '1px solid #e8e8e8' }}>
        ...
        <PageHeader
          title="Om Frem-31"
          description="Vi er en idrettsklubb på nedre Stabekk med lange tradisjoner innen fotball og bandy."
        />
      ...
      <section style={{ borderTop: '1px solid #e8e8e8' }}>
        ...
        {/* image right (default) */}
        <Split
          title="Frembanen — vår hjemmebane siden 1931"
...
const sampleRichText: RichTextNode[] = [
  { type: 'heading', level: 2, text: 'Om Frem-31' },
  {
    type: 'paragraph',
    children: [
      { text: 'Frem-31 er en idrettsklubb på nedre Stabekk med lange tradisjoner innen ' },
...
const membershipTiers = [
  ...
  },
  {
    ...
    price: 'kr 300 / år',
    description:
      'Støtt klubben uten å delta aktivt. Perfekt for tidligere spillere og sympatisører.',
    features: [
      'Klubbmedlemsblad og nyhetsbrev',
      'Stemmerett på årsmøtet',
  ...
  },
  {
    ...
    rows: [
      { label: 'Lego League', price: 'kr 800 / sesong', note: 'Oktober–januar' },
      {
        label: 'Sommerskole',
        price: 'kr 1 500 / uke',
        note: 'Per uke, søskenmoderasjon tilgjengelig',
      },
      {
        label: 'Baneleie (ekstern)',
        price: 'kr 500 / time',
        note: 'Kun tilgjengelig utenfor treningstider',
      },
    ],
  },
];
